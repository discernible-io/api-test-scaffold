...
# Env:
#   TLS_CN     Common Name / primary DNS SAN (default: webhook.discernible.io)
#   CERT_DAYS  Validity in days (default: 825)
#   EXTRA_SANS Comma-separated extra SAN entries (e.g. DNS:foo.example.com,IP:203.0.113.10)
...
TLS_CN="${TLS_CN:-webhook.discernible.io}"
