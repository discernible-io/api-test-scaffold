...
| GET | `/api/identity/token/{tokenId}/dn` | Get Distinguished Name for token | Bearer |
...
| GET | `/api/me/identity` | Get authenticated agent's own identity (self-identification only) | Bearer |
