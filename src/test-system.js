...
const testModuleMapping = {
  ...
  authenticationPositive: "./test-modules/authentication-positive",
  discovery: "./test-modules/discovery-endpoints",
  policyWellKnown: "./test-modules/policy-well-known",
  publicEndpoints: "./test-modules/public-endpoints",
  adminSpecialEndpoints: "./test-modules/admin-special-endpoints",
  mcpTransport: "./test-modules/mcp-transport",
