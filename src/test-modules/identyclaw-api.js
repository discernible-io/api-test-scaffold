...
const identyclawApiTests = {
  ...
  testHolaHandshakeValidation: async (apiEndpoint) => {
    ...
    try {
      ...
      // expectedCode matches api-docs/target-swagger.json: HTTP 400 uses umbrella `HOLA_VALIDATION_FAILED`
      // with specifics in `error.details.reasonCode` (same family as /api/testhola).
      const invalidHolaTests = [
        { hola: "", desc: "empty string", expectedCode: "HOLA_VALIDATION_FAILED" },
        { hola: "HOLA", desc: "missing all fields", expectedCode: "HOLA_VALIDATION_FAILED" },
        { hola: "HOLA/", desc: "only prefix", expectedCode: "HOLA_VALIDATION_FAILED" },
        { hola: "HOLA/tokenId", desc: "missing timestamp and other fields", expectedCode: "HOLA_VALIDATION_FAILED" },
        ...
        // { hola: await generateValidHola(client, { tokenId: 'INVALIDTOKEN' }), desc: "invalid tokenId (uppercase)", expectedCode: "HOLA_VALIDATION_FAILED" },
        { hola: await generateValidHola(client, { tokenId: 'aaaaaaaaaa' }), desc: "tokenId too short (10 chars)", expectedCode: "HOLA_VALIDATION_FAILED" },
        { hola: await generateValidHola(client, { tokenId: 'aaaaaaaaaaaaaa' }), desc: "tokenId too long (14 chars)", expectedCode: "HOLA_VALIDATION_FAILED" },
        { hola: "HOLA/MUNDO/aaaaaaaaaaaa/BADTIMESTAMP/4F9A3C7E/API.IDENTYCLAW.COM/n3FZ5kQ8/Lh2BsM1xY/7", desc: "invalid timestamp format", expectedCode: "HOLA_VALIDATION_FAILED" },
        { hola: "HOLA/MUNDO/aaaaaaaaaaaa/2026-04-04T10:10:00Z/NOTAHEX/API.IDENTYCLAW.COM/n3FZ5kQ8/Lh2BsM1xY/7", desc: "invalid hex in noncets", expectedCode: "HOLA_VALIDATION_FAILED" },
        { hola: "HOLA/MUNDO/aaaaaaaaaaaa/2026-04-04T10:10:00Z/4F9A3C7E/WRONG.DOMAIN.COM/n3FZ5kQ8/Lh2BsM1xY/7", desc: "wrong domain", expectedCode: "HOLA_VALIDATION_FAILED" },
        { hola: "HOLA/MUNDO/aaaaaaaaaaaa/2026-04-04T10:10:00Z/4F9A3C7E/API.IDENTYCLAW.COM//7", desc: "empty signature", expectedCode: "HOLA_VALIDATION_FAILED" },
        { hola: "HOLA/MUNDO/aaaaaaaaaaaa/2026-04-04T10:10:00Z/4F9A3C7E/API.IDENTYCLAW.COM/n3FZ5kQ8/Lh2BsM1xY/", desc: "empty checksum", expectedCode: "HOLA_VALIDATION_FAILED" },
        { hola: (() => { const msg = `HOLA/MUNDO/aaaaaaaaaaaa/2026-04-04T10:10:00Z/4F9A3C7E/API.IDENTYCLAW.COM/n3FZ5kQ8/Lh2BsM1xY/`; return msg + 'ZZ'; })(), desc: "invalid checksum (wrong characters)", expectedCode: "HOLA_VALIDATION_FAILED" },
      ];
  ...
  testHelloStringLengthLimit: async (apiEndpoint) => {
    ...
    try {
      ...
      // so those cases will always fail with HOLA_VALIDATION_FAILED (or related validation).
