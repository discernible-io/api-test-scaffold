...
router.get('/', authenticate_apicall, authorize, async (req, res) => {
  ...
  try {
    ...
    let sessionDebugInfo = {
      scope: "instance",
      note:
        "Session counts reflect this Node process only; aggregate across replicas in your load balancer or logs."
    };
    ...
    const transformedMetrics = {
      ...
      active: activeSessionCount,
      // Per-endpoint metrics with percentiles
      endpointMetrics: rawMetrics.endpointMetrics || {},
      ...rawMetrics
    };
